...
public class AdminHome extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String problem_description = request.getParameter("problem-description");
        ...
        try {
            ...
            String sql = "INSERT INTO submitproblem (name, email, contect, location, problem, image1, image2, image3) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            e.printStackTrace();
            response.sendRedirect("problemNotSubmit.jsp"); // Redirect to error page
        }
    }
}
