<%-- 
    Document   : unsuccessNewAdminRegistration
    Created on : 14 Apr, 2024, 2:50:31 PM
    Author     : naveen
--%>
...
<html>
 ...
 <div id="popup" class="active">
        ...
        <div style="margin-top: 20px;"><a id="redirect-link" href="newAdminRegistration.jsp">OK</a></div>
    </div>
    </body>
</html>
